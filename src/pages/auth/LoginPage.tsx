            ...
            <div className="hidden lg:flex lg:w-1/2 bg-brand-blue p-12 flex-col justify-between text-white relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <h2 className="text-5xl font-black mt-20 leading-tight">
                        Welcome back <br /> to the <span className="text-brand-pink">Platform</span>.
                    </h2>
                    <p className="mt-6 text-xl text-blue-100 max-w-md">
                        Access to your profile to manage your articles and projects.
                    </p>
                </div>
            ...
            <div className="grow flex items-center justify-center p-6 md:p-12 relative">
                ...
                <div className="w-full max-w-md">
                    <div className="mb-10 lg:hidden flex flex-col items-center">
                        ...
                        <h1 className="text-3xl font-black dark:text-white">Login</h1>
                    </div>

                    <div className="hidden lg:block mb-10">
                        <h1 className="text-4xl font-black text-slate-950 dark:text-white">Sign in</h1>
                    ...
                    <p className="mt-8 text-center text-sm text-slate-500 lg:hidden">
                        ...
                        <Link to="/register" className="text-brand-blue font-bold">Register now</Link>
                    </p>
                </div>
            </div>
        </div>

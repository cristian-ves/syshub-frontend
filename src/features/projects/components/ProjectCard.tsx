            ...
            <div className="grow">
                <header className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{project.areaName}</span>
                    </div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-6 font-medium italic">"{project.description}"</p>
            ...
            <footer className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-xs font-bold text-slate-700 dark:text-slate-200">{project.authorName}</span>
                    </div>
                </div>

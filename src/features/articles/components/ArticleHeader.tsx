        ...
        <header className="mb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 pb-8 border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-none">Author</p>
                        <p className="text-sm font-bold text-slate-900 dark:text-slate-100">{article.author.fullName}</p>
                    </div>
                </div>
